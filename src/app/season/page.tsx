...
export const metadata: Metadata = {
  title: "FTC Season",
  description: "Explore the current FTC season details, including game rules for INTO THE DEEP, our build progress, and tournament timeline.",
};
const seasonTimeline = [
  { date: "SEPT 2024", title: "Kickoff", description: "Season kickoff — new game revealed. Teams receive the Game Manual." },
  { date: "OCT — DEC 2024", title: "Build Season", description: "Design, prototype, build, and program competition robots." },
  { date: "JAN — FEB 2025", title: "Qualifier Events", description: "Regional qualifier tournaments for advancement." },
  { date: "MAR — APR 2025", title: "Championship Events", description: "Regional and national championship events." },
  { date: "APR 2025", title: "World Championship", description: "FIRST World Championship — best teams worldwide." },
  { date: "MAY — AUG 2025", title: "Off-Season", description: "Off-season events, outreach, recruiting, and preparation." },
];
      ...
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="bg-[#1c2333] rounded-lg p-8 md:p-12 border border-white/[0.06] text-center">
            <h2 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "var(--font-heading)" }}>INTO THE DEEP</h2>
            <p className="text-[#ff6b35] text-sm font-bold tracking-[2px] uppercase mb-4" style={{ fontFamily: "var(--font-heading)" }}>2024 — 2025 SEASON</p>
            <p className="text-gray-400 font-light max-w-[700px] mx-auto">
              INTO THE DEEP℠ presented by RTX challenges teams to design, build, and program robots to collect and score samples in various zones.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#161b22]">
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {[
              { emoji: "", label: "HK CHAMPIONSHIP", title: "China — Hong Kong Championship", desc: "Competed against teams from across the region.", tags: ["2025", "Regional"] },
              { emoji: "", label: "TW CHAMPIONSHIP", title: "Chinese Taipei Championship", desc: "Home competition in Taiwan with improved performance.", tags: ["2025", "National"] },
            ].map((r) => (
              <div key={r.label} className="bg-[#1c2333] rounded-lg overflow-hidden border border-white/[0.06]">
                <div className="h-[160px] flex flex-col items-center justify-center gap-2" style={{ background: "linear-gradient(135deg, #1c2333, #2a1a10)" }}>
