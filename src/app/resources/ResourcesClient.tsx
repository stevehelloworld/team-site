...
export default function ResourcesClient() {
  ...
  useEffect(() => {
    document.title = `${t("navbar", "resources")} | VIS Mars #32760`;
  }, [t]);
            ...
            <div className="bg-[#1c2333]/60 backdrop-blur-md rounded-2xl p-8 border border-white/[0.04] hover:border-[#ff6b35]/30 transition-all duration-300 flex flex-col justify-between group">
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-4" style={{ fontFamily: "var(--font-heading)" }}>
                  {t("resources", "repoTitle")}
                </h3>
                <p className="text-gray-400 font-light text-sm leading-relaxed mb-6">
                  {t("resources", "repoDesc")}
                </p>
              </div>
              <a
                href="https://github.com"
                target="_blank"
                className="inline-flex items-center gap-2 text-white font-bold text-xs uppercase tracking-[1px] hover:text-[#ff6b35] transition-colors duration-300 w-max no-underline"
              >
                {t("resources", "repoLink")}
              </a>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="bg-[#1c2333]/40 border border-white/[0.04] rounded-2xl p-8 md:p-10 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>
                  {t("resources", "brandGuidelines")}
                </h3>
                <p className="text-gray-400 font-light text-[0.95rem] leading-relaxed mb-8">
                  {t("resources", "brandSub")}
                </p>

                {/* Color blocks */}
                <div className="space-y-4 mb-8">
                  <h4 className="text-white text-xs font-bold uppercase tracking-[1px]">
                    {t("resources", "standardColors")}
                  </h4>
                ...
                <div className="space-y-2">
                  <h4 className="text-white text-xs font-bold uppercase tracking-[1px] mb-2">
                    {t("resources", "standardTypography")}
                  </h4>
                  <div className="space-y-3 bg-[#0d1117]/60 rounded-xl p-4 border border-white/[0.04]">
                    ...
                    <div>
                      ...
                      <span className="block text-gray-300 text-sm font-light">
                        {t("resources", "bodyFontName")}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#1c2333]/40 border border-white/[0.04] rounded-2xl p-8 md:p-10 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>
                  {t("resources", "downloadsTitle")}
                </h3>
                <p className="text-gray-400 font-light text-[0.95rem] leading-relaxed mb-8">
                  {t("resources", "downloadsDesc")}
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-[#0d1117]/40 border border-white/[0.04] rounded-xl p-5 hover:border-[#ff6b35]/20 transition-all duration-300">
                    <div>
                      <h4 className="text-white font-bold text-sm">
                        {t("resources", "logoVector")}
                      </h4>
                      <p className="text-gray-500 text-xs mt-1">
                        {t("resources", "logoVectorDesc")}
                      </p>
                    </div>
                    <a href="#" className="bg-[#ff6b35] text-[#0d1117] text-xs font-bold px-4 py-2 rounded hover:bg-[#ff8c5a] transition-colors no-underline">SVG</a>
                  </div>
                  ...
                  <div className="flex justify-between items-center bg-[#0d1117]/40 border border-white/[0.04] rounded-xl p-5 hover:border-[#ff6b35]/20 transition-all duration-300">
                    <div>
                      ...
                      <p className="text-gray-500 text-xs mt-1">
                        {t("resources", "logoPngDesc")}
                      </p>
                    </div>
                    <a href="#" className="bg-[#ff6b35] text-[#0d1117] text-xs font-bold px-4 py-2 rounded hover:bg-[#ff8c5a] transition-colors no-underline">PNG</a>
                  </div>

                  <div className="flex justify-between items-center bg-[#0d1117]/40 border border-white/[0.04] rounded-xl p-5 hover:border-[#ff6b35]/20 transition-all duration-300">
                    <div>
                      <h4 className="text-white font-bold text-sm">
                        {t("resources", "slidesTemplate")}
                      </h4>
                      <p className="text-gray-500 text-xs mt-1">
                        {t("resources", "slidesTemplateDesc")}
                      </p>
                    </div>
                    <a href="#" className="bg-[#ff6b35] text-[#0d1117] text-xs font-bold px-4 py-2 rounded hover:bg-[#ff8c5a] transition-colors no-underline">PPTX</a>
                  </div>
                </div>
              </div>
            </div>
